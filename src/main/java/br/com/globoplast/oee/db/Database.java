...
public class Database {
    ...
    public void initialize() throws Exception {
        ...
        try (Connection c = open(); Statement s = c.createStatement()) {
            ...
            s.executeUpdate("CREATE TABLE IF NOT EXISTS erp_estoque_raw (erp_id INTEGER PRIMARY KEY, ordem INTEGER, produto TEXT, descricao TEXT, lote TEXT, localizacao TEXT, divisao TEXT, data_producao TEXT, quantidade REAL, qtd_caixas REAL, conteudo INTEGER, payload_hash TEXT NOT NULL, sincronizado_em TEXT NOT NULL)");
            ...
            ensureColumn(c, "historico_oee", "editado_em", "ALTER TABLE historico_oee ADD COLUMN editado_em TEXT");
            ensureColumn(c, "historico_oee", "origem", "ALTER TABLE historico_oee ADD COLUMN origem TEXT NOT NULL DEFAULT 'MANUAL'");
            ensureColumn(c, "historico_oee", "turno_a_lancado_em", "ALTER TABLE historico_oee ADD COLUMN turno_a_lancado_em TEXT");
            ensureColumn(c, "historico_oee", "turno_b_lancado_em", "ALTER TABLE historico_oee ADD COLUMN turno_b_lancado_em TEXT");
            ensureColumn(c, "historico_oee", "turno_c_lancado_em", "ALTER TABLE historico_oee ADD COLUMN turno_c_lancado_em TEXT");
            ...
            s.executeUpdate("CREATE INDEX IF NOT EXISTS idx_erp_estoque_ordem ON erp_estoque_raw(ordem)");
            s.executeUpdate("CREATE INDEX IF NOT EXISTS idx_erp_estoque_produto ON erp_estoque_raw(produto)");
            s.executeUpdate("CREATE INDEX IF NOT EXISTS idx_erp_estoque_localizacao ON erp_estoque_raw(localizacao)");
            ...
            s.executeUpdate("CREATE INDEX IF NOT EXISTS idx_historico_oee_origem ON historico_oee(origem, id DESC)");
        }
    }
