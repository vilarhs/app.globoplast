...
public class Database {
    ...
    public void initialize() throws Exception {
        ...
        try (Connection c = open(); Statement s = c.createStatement()) {
            ...
            // Mesmas migrações defensivas da appv723 para bancos criados por versões anteriores.
